      ...
      {currentItems?.map((item, index) => (
        <button
          ...
          className={`
            ...
            } ${props.selectMode && item?.isOwner ? 'after:w-6 after:h-6 after:absolute after:border-2 after:bg-white after:rounded-xs after:border-stone after:top-2 after:right-2 after:z-10' : ' group '} 
