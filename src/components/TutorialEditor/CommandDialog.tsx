...
interface CommandDialogProps {
    setCommandDialog: React.Dispatch<
        React.SetStateAction<CommandDialogInterface>
    >;
...
const CommandDialog = (props: CommandDialogProps) => {
    const {
        commandDialog,
        setCommandDialog,
        setCommandDialogOpened,
        handleSubmitCommand,
    } = props;
    return (
        <Dialog
            open={commandDialog.isOpen}
            onOpenChange={setCommandDialogOpened}
        >
            <DialogContent className="bg-white">
                ...
                <TextInput
                    ...
                    handleChange={(val: string) =>
                        setCommandDialog({
                            ...commandDialog,
                            fields: commandDialog.fields.map((el, index) =>
                                index === 0 ? (el = val) : el
                            ),
                        })
                    }
