...
const TermDialog = (props: TermDialogProps) => {
    const { setTermDialog, termDialog, setTermDialogOpened, handleSubmitTerm } =
        props;
    ...
    const [displayedTerms, setDisplayedTerms] =
        useState<TermInterface[]>(hardcodeTermins);
                    ...
                    {selectOpened && (
                        <div className="mx-auto flex w-[96%] flex-col gap-y-4 border-t border-tertiary-grey-dim pt-4">
                            <input
                                ...
                                value={inputValue}
                                onChange={(e) =>
                                    handleTermInputChange(e.target.value)
                                }
                            />
                ...
                <DialogFooter>
                    <Button
                        ...
                        disabled={
                            ...
                            termDialog.explanation.replace(/\s+/g, '')
                                .length === 0
                        }
                    >
                        <p>Save</p>
