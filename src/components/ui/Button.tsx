...
const buttonVariants = cva(
    'flex flex-row gap-x-6 rounded-[4px] border px-6 py-3 [&>div]:text-2xl transition-colors duration-200 [&>div]:leading-6 [&>p]:text-base',
    {
        variants: {
            variant: {
                default:
                ...
                dashed: 'flex flex-row justify-center items-center border-dashed border-[2px] border-bg-tertiary-grey-stone bg-background-seasalt text-tertiary-grey-dim',
                elements:
