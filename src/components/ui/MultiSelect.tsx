				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"flex text-base p-1 py-4 rounded-sm border border-dim min-h-10 h-auto items-center justify-between bg-seasalt hover:bg-inherit [&_svg]:pointer-events-auto",
							...
							{selectedValues.length > 0 ? (
												...
												return (
													<Badge
														...
														className={cn(
															...
															"[&>svg]:pointer-events-auto text-black"
														)}
														style={{
															...badgeStyle,
															animationDuration: `${
								...
								<div className="flex items-center justify-between w-full mx-auto">
									<span className="text-base text-muted-foreground mx-3">
										{placeholder}
									</span>
								...
								{!hideSelectAll && !searchValue && (
									<CommandGroup>
										<CommandItem
											...
											className="cursor-pointer bg-white data-selected:bg-seasalt">
											<div
												className={cn(
											...
											{group.options.map((option) => {
												...
												return (
													<CommandItem
														...
														className={cn(
															"cursor-pointer bg-white data-selected:bg-seasalt",
								...
								<CommandGroup>
									<div className="flex items-center gap-2 justify-between">
										{selectedValues.length > 0 && (
											<>
												<CommandItem
													...
													className="flex-1 border data-selected:bg-seasalt justify-center cursor-pointer">
													Clear
												</CommandItem>
												{/*<Separator*/}
												{/*	orientation="vertical"*/}
										...
										<CommandItem
											...
											className="flex-1 border data-selected:bg-seasalt justify-center cursor-pointer max-w-full">
											Close
										</CommandItem>
									</div>
								</CommandGroup>
